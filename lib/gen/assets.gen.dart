...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/pull_refresh.json
  LottieGenImage get pullRefresh =>
      const LottieGenImage('assets/animations/pull_refresh.json');
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/error_snackbar.svg
  SvgGenImage get errorSnackbar =>
      const SvgGenImage('assets/svg/error_snackbar.svg');
  ...
  /// File path: assets/svg/success_check.svg
  SvgGenImage get successCheck =>
      const SvgGenImage('assets/svg/success_check.svg');

  /// File path: assets/svg/success_snackbar.svg
