...
part of 'fav_package_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FavPackageModel _$FavPackageModelFromJson(Map<String, dynamic> json) =>
    FavPackageModel(
...
Map<String, dynamic> _$FavPackageModelToJson(FavPackageModel instance) =>
    <String, dynamic>{
      'id': instance.id,
