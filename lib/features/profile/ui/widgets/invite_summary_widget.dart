            ...
            OnTap(
              onTap: () {
                showContactPickerSheet(
                  context,
                  onConfirm: (list) {
                    context.read<InvitationTrackingCubit>().addedGuest(
                      listGuest: list,
                    ...
                    child: OnTap(
                      onTap: () {
                        if (acceptedList.isNotEmpty) {
                          showContactSelectedSheet(context, acceptedList);
                        }
                      },
                      child: _StatCard(
                        ...
                        gradientColors: [AppColors.white, Color(0x1A16A34A)],
                          ...
                          child: OnTap(
                            onTap: () {
                              if (pendingList.isNotEmpty) {
                                showContactSelectedSheet(context, pendingList);
                              }
                            },
                            child: _StatCard(
                              size: 40.h,
                          ...
                          child: OnTap(
                            onTap: () {
                              if (rejectedList.isNotEmpty) {
                                showContactSelectedSheet(context, rejectedList);
                              }
                            },
                            child: _StatCard(
                              size: 35.h,
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  LocaleKeys.totalGuestsInvited.tr(
                    args: ['${data.totalInvited}'],
                  ),
