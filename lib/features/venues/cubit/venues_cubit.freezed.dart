...
abstract class $VenuesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({VenuesStateStatus currState, List<ProductModel> venuesList});
...
class _$VenuesStateCopyWithImpl<$Res, $Val extends VenuesState>
  ...
  @override
  $Res call({Object? currState = null, Object? venuesList = null}) {
    return _then(
      _value.copyWith(
...
class _$VenuesStateImpl implements _VenuesState {
  ...
  @override
  String toString() {
    return 'VenuesState(currState: $currState, venuesList: $venuesList)';
  }
