...
abstract class IVendorDetailsRepository {
  ...
  Future<Result<PackageDetailsModel>> packageDetails({required int id});
  Future<Result<bool>> wishlistVendor({required int id});
  Future<Result<PackageDetailsModel>> wishlistPackage({required int id});
